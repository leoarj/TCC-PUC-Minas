...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("api-monitoramento-barragens-cache");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("api-monitoramento-barragens-cache");
        ...
        config.getMapConfigs().put("br.com.pucminas.tcc.sca.backend.api.monitoramento.barragens.domain.*", initializeDomainMapConfig(jHipsterProperties));
