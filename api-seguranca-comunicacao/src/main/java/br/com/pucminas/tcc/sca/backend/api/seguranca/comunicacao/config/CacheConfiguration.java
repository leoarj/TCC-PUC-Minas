...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("api-seguranca-comunicacao-cache");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("api-seguranca-comunicacao-cache");
        ...
        config.getMapConfigs().put("br.com.pucminas.tcc.sca.backend.api.seguranca.comunicacao.domain.*", initializeDomainMapConfig(jHipsterProperties));
