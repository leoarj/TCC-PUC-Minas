...
import { PlanoAcaoComponent } from 'app/entities/ApiSegurancaComunicacao/plano-acao/plano-acao.component';
...
describe('Component Tests', () => {
  describe('PlanoAcao Management Component', () => {
    let comp: PlanoAcaoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PlanoAcaoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.planoAcaos && comp.planoAcaos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
